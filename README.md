...
# mt7915-killer
MT7915-Killer is a high-performance driver branch for MediaTek MT7915 (Wi-Fi 6). Based on [openwrt/mt76](https://github.com/openwrt/mt76) (Dec 2022) with patches up to March 2026 (excl. WED), Unlike generic drivers, it employs "hardware-level logic overrides" to prevent the CPU saturation and performance aging common on low-power silicon.
