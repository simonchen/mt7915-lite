...
Specifically, the bottleneck of MT7621 is not data forwarding, but the massive HRTIMER scheduling overhead required to maintain Wi-Fi 6 RX precision under high load.
